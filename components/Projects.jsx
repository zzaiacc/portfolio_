...
const Projects = () => {
  return (
    <div className="max-w-[1300px] m-auto lg:mt-[110px] md:mt-[30px] ">
      <h1 className="font-black   text-[5rem] text-purple-800 space-x-[-3%] lg:text-start lg:p-0 md:pl-[80px] lg:mb-10 md:mb-5 xs:text-center">
        PROJECTS
      </h1>
        ...
        <ul className="gap-10 flex flex-col max-w-[100vw]">
          <li className="bg-purple-800 mx-auto p-[20px] lg:flex md:flex sm:flex  text-white lg:w-[100%] md:w-[80%]  relative rounded-md lg:justify-start sm:justify-center">
            ...
            <div className="flex justify-center">
              <a
                href=""
                className=" text-yellow-300 lg:absolute sm:absolute bottom-10 sm:bottom-5 right-10 font-black  hover:tracking-widest duration-700  xs:static xs:text-center xs:mt-5"
              >
                LIVE DEMO
              </a>
            </div>
