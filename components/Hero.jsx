      ...
      <div className="bg-gradient-to-br  from-purple-500 via-purple-600 to-purple-700 lg:h-[100vh] md:h-[80vh]  xs:h-[80vh]  relative rounded-2xl max-w-[97vw] ">
        ...
        >
          <div>
            ...
            <h2 className="lg:absolute text-center lg:text-[189px]  left-0 bottom-[224px] lg:px-[6.7%] lg:word-spacing-[5rem]">
              FRONT <span className="relative  lg:z-10 lg:pl-[5rem]">END</span>
            </h2>
            <h2 className=" lg:absolute text-center  lg:text-[189px] mb-[3%]  bottom-0  right-0 lg:px-[6.7%] z-10">
              DEVELOPER{" "}
            </h2>
          </div>
        </div>
