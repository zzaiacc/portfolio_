...
const Hero = () => {
  return (
    <div className="m-[20px] align-middle lg:h-[100vh] md:h-[85vh] sm:min-h-[750px] max-w-[100vw] ">
      <div className="bg-gradient-to-br  from-purple-500 via-purple-600 to-purple-700 lg:h-[100vh] md:h-[80vh] sm:min-h-[750px] xs:h-[90vh]  relative rounded-2xl max-w-[97vw] ">
        <NavBar />
        ...
        >
          <div>
            ...
            <h2 className="lg:absolute text-center lg:mb-[5%]  left-0 bottom-[120px] lg:px-[180px] lg:tracking-[-10px] lg:word-spacing-[5rem]">
              FRONT <span className="relative  lg:z-10 lg:pl-[5rem]">END</span>
            </h2>
            <h2 className=" lg:absolute text-center  mb-[3%]  bottom-0  right-0 lg:px-[180px] z-10">
              DEVELOPER{" "}
            </h2>
          </div>
        </div>
